...
resource "azurerm_kubernetes_cluster" "this" {
  ...
  dynamic "default_node_pool" {
    for_each = try(var.node_pools[local.default_pool][*], {})
    content {
...
resource "azurerm_role_assignment" "this" {
  ...
  principal_id         = var.identity == null ? azurerm_kubernetes_cluster.this.service_principal[0].client_id : azurerm_kubernetes_cluster.this.identity[0].principal_id
  scope                = each.value
  role_definition_name = "Contributor"
}

module "identities" {
  source           = "app.terraform.io/ptonini-org/managed-identity/azurerm"
  version          = "~> 1.0.0"
